...
import { ApiService, CurrencyService } from '@shared/public-api';
import {
        ...
        sections: [
          {
            fields: [
              ...
              {
                key: 'fssai_license',
                label: 'FSSAI License (food vendors)',
                type: 'text',
                optional: true,
        ...
        sections: [
          {
            fields: [
              ...
              },
              {
                ...
                patternMessage: 'Invalid IFSC layout.',
              },
              {
                key: 'bank_name',
                label: 'Bank Name',
        ...
        sections: [
          {
            fields: [
              ...
              { key: 'closing_time', label: 'Closing Time', type: 'time' },
              {
                ...
                label: `Min Order Amount (${this.currency.getSymbol()})`,
                type: 'number',
                placeholder: '0',
              },
              {
